...
class Puck{
public:
    Puck(float forceZ, float dirY, float speedX); // Initialization With All Values as 0
    Puck(Point3D pos, Vec3D dir, float friction, float spd); // Initialization With Given Values
